...
public:
    ...
    // Mask-Rcnn
    cv::Mat DynamicExtract(const cv::Mat &im, cv::Mat &mask,float confThreshold, float maskThreshold, bool useOptical = false, cv::InputArray imTh = cv::noArray());
...
public:
    ...
    //DynamicExtractor *mpDynmicExtractor;
    // Frame timestamp.
    double mTimeStamp;
